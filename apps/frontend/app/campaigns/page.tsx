...
import { Plus, Play, Pause, Trash2, Users, LogOut } from 'lucide-react';
                ...
                <div className="flex items-center gap-2">
                  {c.status !== 'active' && (
                    <button
                      ...
                      className="flex items-center gap-1 text-xs bg-green-950 text-green-400 border border-green-800 px-3 py-1.5 rounded-lg hover:bg-green-900 transition-colors"
                    >
                  ...
                  {c.status === 'active' && (
                    <button
                      ...
                      className="flex items-center gap-1 text-xs bg-yellow-950 text-yellow-400 border border-yellow-800 px-3 py-1.5 rounded-lg hover:bg-yellow-900 transition-colors"
                    >
